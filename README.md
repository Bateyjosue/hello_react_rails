...
#  # react_rails_webpack <a name="about-project"></a>

> It's a react rails boilerplate to get started with react rails as one app with webpack
...
```
  git clone https://github.com/Bateyjosue/react_rails_webpack.git
